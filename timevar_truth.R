...
truth <- data.frame(n.conf = c(1, 1, 3, 3),
                    lambda = c(0.01, 0.05, 0.01, 0.05),
                    rd = rep(NA, 4))
...
truth$rd[1] <- conf1(lambda=0.01)
truth$rd[2] <- conf1(lambda=0.05)
...
truth$rd[3] <- conf3(lambda=0.01)
truth$rd[4] <- conf3(lambda=0.05)
